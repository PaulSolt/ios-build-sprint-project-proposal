...
1. Team Members: `<Lydia>`
2. App Name: `<App Dev Portfolio Tracker>`
3. App Description (3-5 sentences):

    `<An app that shows all your work/project in a field(This case it's the tech field)>`
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    `<Programmer>`
    
5. Github code repository: `<https://github.com/art4everyan/App-Dev-Portfolio-Tracker>`
6. Github Project/Trello Board: `<https://trello.com/b/VFCcvdog/app-dev-portfolio-tracker>`
...
1. `<Feature 1: Add and manage projects(Should be able to manage all project in a convient way)>`
2. `<Feature 2: Account Networking(People can follow each other)>`
3. `<Feature 3: May be account can create post(Stretch)>`
